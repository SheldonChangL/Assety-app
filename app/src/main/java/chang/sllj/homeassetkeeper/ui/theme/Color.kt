...
// ── Semantic color aliases used in custom UI ──────────────────────────────────
/** Warm amber for warranty-expiry warnings (used in both light and dark). */
val WarningAmber  = Color(0xFFF9A825)
/** Soft red for already-expired items. */
val ErrorRed      = Color(0xFFB71C1C)
/** Calm green for in-warranty / all-good states. */
